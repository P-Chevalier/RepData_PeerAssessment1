...
``` 
##### The mean of the total number of steps per day: `r mean_number_of_steps`.  
##### The median of the total number of steps per day: `r median_number_of_steps`.  
...
##### The interval - `r maximum_number_of_steps_interval` had the maximum of `r maximum_number_of_steps` number of steps.
...
##### The total number of NAs in the activity data is: `r total_number_of_NAs`.  
...
##### The mean of the imputed total number of steps per day: `r imputed_mean_number_of_steps`.  
##### The median of the imputed total number of steps per day: `r imputed_median_number_of_steps`.  
